                    ...
                    <div class="col-lg-12">
						<form role="form">
							...
							<div class="form-group">
								<select style="height:150px" multiple class="form-control" id="sel-sup" name="sel-sup"></select>
												...
												<div class="form-group col-lg-12">						
													<div class="panel-body">
														<div class="table-responsive">
														  ...
														  <table id="poItemsTable" class="table table-hover"  style='font-size:12px'>

															<thead id="thead_poitems" name="thead_poitems">
																<tr>
																	<th>QTY</th>
																	<th nowrap>BU SKU</th>
																	<th nowrap>Vendor SKU</th>
																	<th>Description</th>
...
<script src="js/purchase_orders_bo.js"></script>
